...
const schema = z.object({
  ...
  minDelayBetweenSendsMs: z.number().int().min(0).max(120000).default(5),
  maxEmailsPerSmtpSession: z.number().int().min(1).max(50000).default(2000),
  connectionTimeoutSec: z.number().int().min(1).max(600).default(60),
